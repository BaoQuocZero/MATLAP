...
pillsetc_1 = im2bw(pillsetc, 0.1); %Tách ng??ng t? ??ng
tape_1 = im2bw(tape, 0.1); %Tách ng??ng t? ??ng
coins_1 = im2bw(coins, 0.1); %Tách ng??ng t? ??ng
eight_1 = im2bw(eight, 0.1); %Tách ng??ng t? ??ng
